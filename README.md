...
```bash
git clone https://github.com/ShardVisionExemplify/mercury-agent-skills-190.git
cd mercury-agent-skills-190
python setup.py
```
...
```bash
git clone https://github.com/ShardVisionExemplify/mercury-agent-skills-190
```
...
<!-- Last updated: 2026-06-06 17:31:14 -->
